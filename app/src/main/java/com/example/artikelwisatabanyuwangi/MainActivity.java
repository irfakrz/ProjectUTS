package com.example.artikelwisatabanyuwangi;
...
import com.example.artikelwisatabanyuwangi.DataAdapter;
import com.example.artikelwisatabanyuwangi.DataModel;
import com.example.artikelwisatabanyuwangi.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputData("Teluk Hijau", "artikel_1.html");
        inputData("Kawah Ijen", "artikel_2.html");
        inputData("Pulau Merah", "artikel_3.html");
        inputData("Wedi Ireng", "artikel_4.html");
